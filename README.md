...
در تلگرام، فرمان `/post PRODUCT_ID` فقط برای شناسهٔ عددی ادمین فعال است. ربات ابتدا دکمهٔ تأیید را نمایش می‌دهد و پس از تأیید، Workflow ارسال محصول به تلگرام و بله را اجرا می‌کند.
